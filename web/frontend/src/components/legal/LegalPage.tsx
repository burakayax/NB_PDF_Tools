    ...
    <div className="min-h-screen overflow-hidden bg-nb-bg font-sans text-nb-text antialiased">
      ...
      <main className="relative mx-auto w-full max-w-5xl px-6 py-10 sm:px-8 lg:px-12">
        ...
        <section className="mt-10 rounded-[28px] border border-white/[0.08] bg-nb-panel/50 p-8 shadow-[0_40px_90px_-24px_rgba(0,0,0,0.55),0_0_0_1px_rgba(255,255,255,0.04)_inset] backdrop-blur-xl sm:p-11">
          ...
          <div className="mt-6 inline-flex rounded-2xl border border-white/10 bg-nb-bg-soft/50 px-4 py-3 text-sm text-nb-muted">
          ...
          <div className="mt-10 space-y-8">
            {document.sections.map((section) => (
              <section key={section.title} className="rounded-[28px] border border-white/8 bg-nb-bg-soft/40 p-6 sm:p-7">
                <h2 className="text-2xl font-semibold text-nb-text">{section.title}</h2>
                <div className="mt-4 space-y-4 text-sm leading-8 text-nb-muted sm:text-base">
